...
public class MemberController {
	...
	public void selectOne1(String memberName) {
		...
		MemberMenu menu = new MemberMenu();
		List<Member> list = new MemberDao().selectOne1(memberName); //여러 행을 받을 수 있기 때문에 list로 담음
	...
	public void insertMember(Member m) {
		...
		int result = new MemberDao().insertMember(m); // 인서트를 하면 성공행개수가 리턴됨 그래서 int로 받음
	...
	public void updateMember(Member m) {
		...
		int result = new MemberDao().updateMember(m); // 업데이트를 하면 성공행개수가 리턴됨 그래서 int로 받음	
	...
	public void deleteMember(String memberId) {
		...
		int result = new MemberDao().deleteMember(memberId); // 딜리트를 하면 성공행개수가 리턴됨 그래서 int로 받음	
