...
public class Run {
	...
	public static void main(String[] args) {
		...
		//1. 클래스를 만들고나서 자바에서 말하는 객체형태로 만들기 위해 new연산자 통해서 heap메모리영역에 생성해야한다. (즉, 공간할당)
		Student u = new Student(); // 객체 생성
		...
		//직접 접근을 통한 값 가져오기
		System.out.println(i.name + "님의 나이는 " + i.age + "살이고 키는 " + i.height +"cm고 국어점수는 " + i.kor + "점이고 수학점수는 " + i.math + "점입니다." );
